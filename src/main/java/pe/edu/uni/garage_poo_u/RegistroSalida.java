...
import pe.edu.uni.garage_poo_u.Clases.Registro_Salida;
import pe.edu.uni.garage_poo_u.Clases.Sexo;
import pe.edu.uni.garage_poo_u.Clases.Tipo_Documento;
...
public class RegistroSalida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FechaSalida");

        jLabel2.setFont(new java.awt.Font("Agency FB", 1, 24)); // NOI18N
        jLabel2.setText("HoraSalida");

        jLabel3.setFont(new java.awt.Font("Agency FB", 1, 24)); // NOI18N
        jLabel3.setText("idCliente2");

        jLabel4.setFont(new java.awt.Font("Agency FB", 1, 24)); // NOI18N
        jLabel4.setText("IdEmpleado2");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Tipo_Documento tipo_Documento= new Tipo_Documento(jComboBox1.getSelectedItem().toString()); 
        
        Registro_Salida g =new Registro_Salida(jTextField1.getText(), jTextField2.getText(), 
                jTextField3.getText(), jTextField4.getText(), tipo_Documento);                                                             
        try {
            g.guardarSalida("DATOS_SALIDA.txt");
